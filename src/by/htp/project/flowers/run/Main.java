...
public class Main {
	...
	public static void main(String[] args) {
		...
		Flower real = new FlowerReal("Rose", "red", 8, 10.00, "vanil", new Date(2018, 2, 25));
		@SuppressWarnings("deprecation")
		Flower real1 = new FlowerReal("Gvozdika", "white", 7, 8.00, "smoke", new Date(18, 3, 7));
		@SuppressWarnings("deprecation")
...
//		flower.showBouquet();
		...
		System.out.println("jikk");
//		
//		my.setBouquet(flower);
//		System.out.println(my.getPrice() + "$");
//		my.showBouquet();
//		my.sortBouquet();
//		Bouquet mySort = new Bouquet();
//		mySort.setBouquet(mySortBoquet);
//		mySort.showBouquet();
